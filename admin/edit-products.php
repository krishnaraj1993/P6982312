...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $sqlStr = mysqli_query($con, "select * from priceAnalysis,users,products where product=" . $pid . " AND currentPrice > " . $productprice . " AND users.id=priceAnalysis.user AND products.id = priceAnalysis.product");
