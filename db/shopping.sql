...
--
-- Host: localhost:3306
-- Generation Time: Jan 10, 2021 at 09:58 PM
...
INSERT INTO `admin` (`id`, `username`, `firstname`, `phonenumber`, `password`, `role`, `creationDate`, `updationDate`, `status`) VALUES
(1, 'admin', 'Anup', '984540000', '735730b5ec1303aa7b090f06ad3331f5', 'ADMIN', '2017-01-24 16:21:18', '21-06-2018 08:27:55 PM', 1),
(2, 'retailer', 'Vivek', '827315211', 'ceb6c970658f31504a901b89dcd3e461', 'RETAILER', '2017-01-24 16:21:18', '21-06-2018 08:27:55 PM', 1),
(5, 'test@user', 'test', '9121423461', '202cb962ac59075b964b07152d234b70', 'RETAILER', '2021-01-10 16:08:15', NULL, 1);
...
--
-- Table structure for table `priceAnalysis`
--
...
--
-- Dumping data for table `priceAnalysis`
--

INSERT INTO `priceAnalysis` (`id`, `product`, `currentPrice`, `dateofupdate`, `user`) VALUES
(1, 2, '36990', '2020-12-22 23:32:29', 5),
(2, 2, '36990', '2020-12-22 23:34:52', 5),
(3, 2, '36990', '2020-12-22 23:40:07', 5),
(4, 2, '36990', '2020-12-22 23:41:56', 5),
(5, 2, '36990', '2020-12-22 23:49:24', 5),
(6, 2, '36990', '2020-12-22 23:51:26', 5);
...
(2, 3, 4, 5, 5, 'Anuj Kumar', 'BEST PRODUCT FOR ME :)', 'BEST PRODUCT FOR ME :)', '2017-02-26 20:43:57', 1),
(3, 3, 3, 4, 3, 'Sarita pandey', 'Nice Product', 'Value for money', '2017-02-26 20:52:46', 2),
...
(24, 'kpattar45@gmail.com', 0x3a3a3100000000000000000000000000, '2020-12-22 17:52:59', NULL, 0),
(25, 'kpattar45@gmail.com', 0x3a3a3100000000000000000000000000, '2020-12-22 17:53:06', NULL, 0),
(26, 'kpattar45@gmail.com', 0x3a3a3100000000000000000000000000, '2020-12-22 17:54:00', '22-12-2020 11:55:51 PM', 1);
...
(4, 'krishna', 'kpattar452@gmail.com', 9845409904, '202cb962ac59075b964b07152d234b70', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2020-10-04 03:54:46', NULL),
(5, 'tester', 'kpattar45@gmail.com', 9845409904, '735730b5ec1303aa7b090f06ad3331f5', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2020-12-22 17:53:50', NULL);
...
--
-- Indexes for table `priceAnalysis`
--
ALTER TABLE `priceAnalysis`
  ADD PRIMARY KEY (`id`),
  ADD KEY `product` (`product`),
  ADD KEY `priceAnalysis_ibfk_1` (`user`);
...
--
-- AUTO_INCREMENT for table `priceAnalysis`
--
ALTER TABLE `priceAnalysis`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
--
...
--
-- Constraints for table `priceAnalysis`
--
ALTER TABLE `priceAnalysis`
  ADD CONSTRAINT `priceAnalysis_ibfk_1` FOREIGN KEY (`user`) REFERENCES `users` (`id`),
  ADD CONSTRAINT `priceAnalysis_ibfk_2` FOREIGN KEY (`product`) REFERENCES `products` (`id`);

--
-- Constraints for table `products`
--
ALTER TABLE `products`
  ADD CONSTRAINT `products_ibfk_1` FOREIGN KEY (`updatedBy`) REFERENCES `admin` (`id`);
